...
params:
  ...
  permalink: 08-04-2022-WBKD01-Gastroenteritis
---

```{r, include=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
myname <- "2022-04-08-WBKD-Gastroenteritis"
basepath <- paste0("{{ site.url }}{{ site.baseurl }}/assets/", myname, "/")
presentation_date <- "2022-04-08 08:30:00"
course <- "WBKD 01"
host <- params$host 
...
Über den Vortrag
========================================================
<section style="text-align: left; font-size: 0.8em">

Basisdaten:  
- `r title`  
- `r params$date` `r params$place`   
- `r params$course` `r params$host`  

Wie komme ich an den Vortrag:  
- Online Link: jakobschumacher.github.io/presentations/
