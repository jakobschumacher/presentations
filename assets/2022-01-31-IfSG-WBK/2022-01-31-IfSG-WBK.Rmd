...
* Bitte Chat beachten
<small>Folien sind Thematisch sortiert und sind auch unten (Pfeil nach unten)</small>



```{r eval=TRUE, include=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
loesung1 <- "# das ist ein Test"
```

`r if (exists("loesung1")){loesung1}`
`r if (exists("loesung7")){loesung1}`
...
# I Das Infektionsschutzgesetz {data-background="themis.png"}
...
# IV Diskussion {data-background="discussion.jpg" style="color:black;"}  
...
* Was kann der Dozent besser machen? (Private Nachricht)
